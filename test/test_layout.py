...
class LayoutTestCase(unittest.TestCase):
    ...
    def test_screenshot_with_default_download_folder(self):
        ...
        self.assertEqual(len(os.listdir(self.SCREENSHOT_PATH)) > 0, True, "Failed to create snapshots")
    ...
    def test_screenshot_with_custom_download_folder(self):
        ...
        self.assertEqual(len(os.listdir(self.CUSTOM_DOWNLOAD_FOLDER)) > 0, True, "Failed to create snapshots")
