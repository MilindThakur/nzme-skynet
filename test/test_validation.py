...
class ValidationTestCase(unittest.TestCase):
    ...
    def test_validate_broken_js_file(self):
        im = Validation(os.path.join(self.CUR_DIR,"testdata/brokenjs.json"))
        im.validate()
    ...
    def test_validate_good_js_file(self):
        im = Validation(os.path.join(self.CUR_DIR, "testdata/goodjs.json"))
        im.validate()
